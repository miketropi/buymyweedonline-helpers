    ...
    ?>
      <div class="wrapper-age-gate-custom">
        ...
        <div class="age-gate-note-content">
          ...
          <?php 
            if(!empty($data_age_gate['bh_image_age_gate'])) {
              ?>
                <img class="icon-logo-age" src="<?php echo $data_age_gate['bh_image_age_gate']?>" />  
              <?php
            }
            ...
            if(!empty($data_age_gate['bh_content_restrict_age_gate'])) {
              ?>
                <div class="content-restrict-age-gate">
                  <?php 
                    echo $data_age_gate['bh_content_restrict_age_gate'];
                  ?>

                </div>
              <?php
            }
            if(!empty($data_age_gate['bh_default_age'])) {
              $age_confirm = $data_age_gate['bh_default_age'];
              $text_confirm = $data_age_gate['bh_age_gate_yesno_sub_question'];
              ?>
                <div class="text-confirm-age-gate">
                  <?php 
                    echo sprintf(__($text_confirm, 'your__text_domain'), $age_confirm);
                  ?>
                </div>
              <?php
            }  
          ...
          <div class="button-confirm-age-gate">
              <a href="#" class="confirm-yes">Yes</a>
              <a class="confirm-no" data-redirect="<?php echo $data_age_gate      ['bh_redirect_failures_age_gate']?>" href="#">
                No
              </a>
          </div>
